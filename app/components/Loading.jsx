...
export default function Loading() {
  ...
  return (
    <div className="h-screen duration-500 w-screen bg-black max-sm:-translate-x-[0.1vw] fixed top-0 z-[300]">
      <img
      ...
      />
      <h1 id="loading-count" className="fixed lg:left-[45.4vw] text-white lg:top-[75%] top-[70%] left-[42.5%] text-2xl font-bold">
        0%
      </h1>
    </div>
  )
