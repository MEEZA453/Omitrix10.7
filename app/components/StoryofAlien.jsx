...
export default function StoryOfAlien(){
    ...
    <div className="h-screen w-screen bg-[#ffffff]"></div>
        ...
        <img src ='/image6.webp' className="w-screen h-[100vw] object-cover"/>
        <img src ='/image7.webp' className="w-screen h-[100vw] object-cover"/>
        <img src ='/image8.webp' className="w-screen h-[100vw] object-cover"/>
        <img src ='/image9.webp' className="w-screen h-[100vw] object-cover"/>
